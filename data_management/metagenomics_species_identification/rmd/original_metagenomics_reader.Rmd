...
#show the current version as control
conda --version
```
...
fastqc -o ~/daur2/metagenomics/metagenomics_species_identification/fastqc/ /home/daur2/metagenomics/reader_data/HU1_MOCK1_L001_R1_001.fastq.gz
fastqc -o ~/daur2/metagenomics/metagenomics_species_identification/fastqc/ /home/daur2/metagenomics/reader_data/HU1_MOCK1_L001_R2_001.fastq.gz
...
img1 <-  rasterGrob(as.raster(readPNG(here("metagenomics/metagenomics_species_identification/images/fastqc_mock1_R1_per_base_quality.png"))))
img2 <-  rasterGrob(as.raster(readPNG(here("metagenomics/metagenomics_species_identification/images/fastqc_mock1_R2_per_base_quality.png"))))
...
- --db: database name
- --threads: number of threads (htop ---> load on server)
- --paired: paired-end
- --gzip-compressed: fastq files zijn gezipped
- --output: ouput file in plaats van result op het scherm
- --report: ook een meer human readable file toevoegen
- --use-names: scientific names inplaats van taxids

```{bash, echo=TRUE, eval=FALSE}
# activate environment
conda activate meta

kraken2 --db /home/daur2/metagenomics/minikraken2_v2_8GB_201904_UPDATE/ --threads 2 --paired --gzip-compressed --output ~/daur2/metagenomics/metagenomics_species_identification/kraken2/mock1.kraken --report ~/daur2/metagenomics/metagenomics_species_identification/kraken2/mock1.report --use-names /home/daur2/metagenomics/reader_data/HU1_MOCK1_L001_R1_001.fastq.gz /home/daur2/metagenomics/reader_data/HU1_MOCK1_L001_R2_001.fastq.gz

conda deactivate
```

```{r opbouw report file, message=FALSE, warning=FALSE}
library(tidyverse)
library(here)
report <- read_tsv(here("metagenomics/metagenomics_species_identification/kraken2/mock1.report"), col_names = FALSE)
head(report, n=5L)
```
...
# bracken
bracken -d /home/daur2/metagenomics/minikraken2_v2_8GB_201904_UPDATE/ -i ~/daur2/metagenomics/metagenomics_species_identification/kraken2/mock1.report -o ~/daur2/metagenomics/metagenomics_species_identification/bracken/mock1.bracken
...
kraken-biom ~/daur2/metagenomics/metagenomics_species_identification/kraken2/mock1_bracken_species.report --fmt json -o ~/daur2/metagenomics/metagenomics_species_identification/kraken2/mock1_bracken_species.biom
...
library(phyloseq)
library(ggplot2)
data <- "~/daur2/metagenomics/metagenomics_species_identification/kraken2/mock1_bracken_species.biom"
